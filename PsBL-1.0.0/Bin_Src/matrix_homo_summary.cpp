...
void matrix_homo_summary(const Param &param)
{
    ...
    if(param.genome != "")
    {
        ...
        if(not genome.has(param.chr_id_1) or not genome.has(param.chr_id_2))
        {
        ...
        {
            align_seqs[param.chr_id_1] = genome.seq(param.chr_id_2);
            align_seqs[param.chr_id_1+"_2"] = genome.seq(param.chr_id_2);
        }else{
            clog << "Start to global_align" << "..." << endl;
            global_align(genome.seq(param.chr_id_1), genome.seq(param.chr_id_2), align_seqs[param.chr_id_1], align_seqs[param.chr_id_2], 2, 1);
        }
